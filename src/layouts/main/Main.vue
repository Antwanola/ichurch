          ...
          <div class="router-content">
            <transition :name="routerTransition">
              ...
              >
                ...
                <a
                  v-if="downloadRoute"
                  :href="`https://ichurch-01.herokuapp.com/api${downloadRoute}`"
                  target="_blank"
                  type="download"
                  class="ml-auto md:block hidden cursor-pointer"
                >
                  <vs-button>Download Data</vs-button>
                </a>
              </div>
            </transition>
...
export default {
  ...
  data() {
    return {
      ...
      downloadPages: [
        {
          page: '/first-timers/manage',
          downloadUrl: '/pdf/download-first-timers'
        },
        {
          page: '/payroll/manage',
          downloadUrl: '/pdf/download-payroll'
        },
        {
          page: '/members/manage',
          downloadUrl: '/pdf/download-all-members'
        }
      ]
    }
  },
  ...
  methods: {
    ...
    updateDownloadUrl () {
      for (let i = 0; i < this.downloadPages.length; i++) {
        if (this.downloadPages[i].page === this.$router.currentRoute.path) {
          return this.downloadRoute = this.downloadPages[i].downloadUrl
        }
      }
      this.downloadRoute = ''
    }
