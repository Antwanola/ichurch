  ...
  <vx-card>
    <vs-table stripe :data="categories" max-items="10" pagination id="table">
      <template slot="header">
        <vs-row>
          <vs-col vs-w="6">
            <!-- <h3 class="mb-6">Expense Categories</h3> -->
          </vs-col>
          <vs-col vs-w="6" class="text-right">
            <router-link to="/expenses/new-category">
...
<script>
import { allCategories, delCategory } from '@/api/expenses'
import EditCategory from '@/components/expenses/EditCategory.vue'
